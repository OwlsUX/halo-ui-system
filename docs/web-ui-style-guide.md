...
Do not make new pages single-hue. Halo pages should balance white/light gray surfaces, black/dark gray text, yellow CTAs, restrained blue links, and occasional green success states.
...
- Background `#171717` or `#111111`, text white, radius `8px` or pill by context.
- Hover `#000000`.
...
- Light nav border `#E5E5E5`, links `#525252`, hover `#171717`.
